      ...
      <>
         ...
         <div className="flex justify-center p-3">
            <homeRoute.Link aria-label="ScoreSaber Home">
               <Image src="/scoresaber-pride.svg" width={24} height={24} alt={tSidebar('sidebar.scoreSaberLogoAlt')} priority />
            </homeRoute.Link>
         </div>
               ...
               <Tooltip>
                  <TooltipTrigger asChild>
                     <playerRoute.Link params={{ playerId: user.id }} className={iconLink}>
                        <PlayerAvatar src={user.avatar} alt={user.name} width={24} height={24} className="size-6 rounded-md" />
                     </playerRoute.Link>
                  </TooltipTrigger>
