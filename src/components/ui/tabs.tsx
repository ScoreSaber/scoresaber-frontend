   ...
   'group/tabs-list text-muted-foreground inline-flex items-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col',
   {
      variants: {
         variant: {
            ...
            'compact-pill': 'h-auto w-full rounded-2xl border bg-accent/25 p-0.5',
            'accent-pill': 'h-auto w-full rounded-2xl border bg-accent/25 p-0.5',
   ...
   return (
      <TabsPrimitive.Trigger
         ...
         className={cn(
            ...
            'group-data-[variant=compact-pill]/tabs-list:h-8 group-data-[variant=compact-pill]/tabs-list:rounded-[0.8rem] group-data-[variant=compact-pill]/tabs-list:border-transparent group-data-[variant=compact-pill]/tabs-list:text-[13px] group-data-[variant=compact-pill]/tabs-list:font-semibold group-data-[variant=compact-pill]/tabs-list:shadow-none group-data-[variant=compact-pill]/tabs-list:data-[state=active]:pointer-events-none group-data-[variant=compact-pill]/tabs-list:data-[state=active]:border-transparent dark:group-data-[variant=compact-pill]/tabs-list:data-[state=active]:border-transparent',
            'group-data-[variant=compact-pill]/tabs-list:data-[state=active]:bg-primary group-data-[variant=compact-pill]/tabs-list:data-[state=active]:text-primary-foreground dark:group-data-[variant=compact-pill]/tabs-list:data-[state=active]:bg-primary dark:group-data-[variant=compact-pill]/tabs-list:data-[state=active]:text-primary-foreground',
            'group-data-[variant=accent-pill]/tabs-list:h-8 group-data-[variant=accent-pill]/tabs-list:rounded-[0.8rem] group-data-[variant=accent-pill]/tabs-list:border-transparent group-data-[variant=accent-pill]/tabs-list:text-[13px] group-data-[variant=accent-pill]/tabs-list:font-semibold group-data-[variant=accent-pill]/tabs-list:shadow-none group-data-[variant=accent-pill]/tabs-list:data-[state=active]:pointer-events-none group-data-[variant=accent-pill]/tabs-list:data-[state=active]:border-transparent dark:group-data-[variant=accent-pill]/tabs-list:data-[state=active]:border-transparent',
            'group-data-[variant=accent-pill]/tabs-list:data-[state=active]:bg-[var(--profile-accent,var(--primary))] group-data-[variant=accent-pill]/tabs-list:data-[state=active]:text-[color:var(--profile-accent-active-foreground,var(--primary-foreground))] dark:group-data-[variant=accent-pill]/tabs-list:data-[state=active]:bg-[var(--profile-accent,var(--primary))] dark:group-data-[variant=accent-pill]/tabs-list:data-[state=active]:text-[color:var(--profile-accent-active-foreground,var(--primary-foreground))]',
