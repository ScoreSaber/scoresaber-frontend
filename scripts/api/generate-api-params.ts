...
const SPEC_PATH = resolve(import.meta.dirname, 'openapi.processed.json');
const API_PATH = resolve(ROOT, 'src', 'shared', 'api', 'generated', 'Api.ts');
const OUT_PATH = resolve(ROOT, 'src', 'shared', 'api', 'generated', 'ApiParams.ts');
...
function main() {
   ...
   const lines: string[] = [
      '/* oxlint-disable */',
      '/**',
      ' * AUTO-GENERATED by scripts/api/generate-api-params.ts -- do not edit manually.',
      ' * Re-generate with: vp run api:generate',
      ' */',
      '',
